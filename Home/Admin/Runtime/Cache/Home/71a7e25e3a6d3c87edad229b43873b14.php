...
<div class="bodywrapper">
    ...
    <div class="pageheader">
        <h1 class="pagetitle">顶部菜单</h1>
        <span class="pagedesc">编辑二级及以下子菜单(ps: 若菜单没变化,请手动刷新)</span>
        
        <ul class="hornav">
            <li class="current"><a href="#menu">菜单编辑</a></li>           
        </ul>
    </div><!--pageheader-->
    <div id="contentwrapper" class="contentwrapper">
    	<div id="menu" class="subcontent">
    	<form action="/myblog/admin/index.php/home/Menu/saveTopMenu" class="stdform" method="post">	
    		<p>
		    	<label>菜单编辑：</label>
		        <span class="field">
                    <textarea name="topmenu" id="" cols="20" rows="60">
                        <?php echo ($menu); ?>
                    </textarea>
		        </span>
                <small class="desc">修改菜单时,请勿删除除菜单名称意外的内容
                </small>
    		</p>    		
    		<p class="submitMenu" style="float:right;margin-right:100px;"><button class="submit form-btn">提交</button></p>   		
    	</form>
    	</div>
    </div>
