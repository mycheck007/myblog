 ...
 * 	Changed by coolwayne
 * 	Change Content: theme color change(334 line)
 *	Change data 2015/11/23
...
jQuery(document).ready(function(){
	...
	jQuery('.changetheme a').click(function(){
		...
		if(jQuery('#addonstyle').length == 0) {
			if(c != 'default') {
				jQuery('head').append('<link id="addonstyle" rel="stylesheet" href="../../../../admin/Public/css/style.'+c+'.css" type="text/css" />');
